...
/**
 * @file        kcs/type_traits/type_traits.hpp
 * @brief       type_traits fonctions header.
 * @author      Killian
 * @date        2016/08/05 - 04:44
 */

#ifndef KCS_TYPE_TRAITS_TYPE_TRAITS_HPP
#define KCS_TYPE_TRAITS_TYPE_TRAITS_HPP
...
template<>
struct __is_path_helper<stdfs::path> : public std::true_type {};
} /* __hidden_type_traits */
/** @endcond */
