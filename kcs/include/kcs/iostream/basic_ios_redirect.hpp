...
/**
 * @file        kcs/iostream/basic_ios_redirect.hpp
 * @brief       basic_ios_redirect class header.
 * @author      Killian
 * @date        2017/05/19 - 22:47
 */

#ifndef KCS_IOSTREAM_BASIC_IOS_REDIRECT_HPP
#define KCS_IOSTREAM_BASIC_IOS_REDIRECT_HPP
...
template<
        ...
        typename TpAlloc = std::allocator<TpChar>
>
...
public:
     ...
     */
    basic_ios_redirect(ios_type& ios)
            : ios_(&ios)
...
private:
    ...
    /** Allows to knowing wether the embedded string stream has been constructed. */
