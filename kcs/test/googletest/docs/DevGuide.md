...
Please do submit code. Here's what you need to do:
  ...
  1. A submission should be a set of changes that addresses one issue in the [issue tracker](https://github.com/google/googletest/issues). Please don't mix more than one logical change per submittal, because it makes the history hard to follow. If you want to get a change that doesn't have a corresponding issue in the issue tracker, please create one.
